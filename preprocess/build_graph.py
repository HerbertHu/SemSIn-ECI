...
if __name__ == '__main__':
    ...
    dir_list = ['amr_sample/amr_graph', 'amr_sample/amr_path']
    for dir in dir_list:
    ...
    for mode in ['train', 'dev']:
        ...
        with open(os.path.join(data_path, 'sent_sample', f'{mode}.pkl'), 'rb') as f:
        ...
        with open(os.path.join(data_path, 'amr_sample/amr_graph', f'{mode}.pkl'), "wb") as f:
            pickle.dump(graph_list, f)
        print('Save path networks')
        with open(os.path.join(data_path, 'amr_sample/amr_path', f'{mode}.pkl'), "wb") as f:
            pickle.dump(path_nx_list, f)
        print('Save align data')
        with open(os.path.join(data_path, 'amr_sample/amr_align', f'{mode}.pkl'), "wb") as f:
