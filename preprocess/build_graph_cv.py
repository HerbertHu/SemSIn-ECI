...
if __name__ == '__main__':
    ...
    dir_list = ['amr_sample/amr_graph/5fold', 'amr_sample/amr_path/5fold', 'amr_sample/amr_align/5fold']
    for dir in dir_list:
    ...
    for mode in ['train', 'test']:
        for fold in range(5):
            ...
            with open(os.path.join(data_path, 'sent_sample', f'5fold/{mode}_{fold}.pkl'), 'rb') as f:
            ...
            with open(os.path.join(data_path, 'amr_sample/amr_graph', f'5fold/{mode}_{fold}.pkl'), "wb") as f:
                pickle.dump(graph_list, f)
            print('Save path networks')
            with open(os.path.join(data_path, 'amr_sample/amr_path', f'5fold/{mode}_{fold}.pkl'), "wb") as f:
                pickle.dump(path_nx_list, f)
            print('Save align data')
            with open(os.path.join(data_path, 'amr_sample/amr_align', f'5fold/{mode}_{fold}.pkl'), "wb") as f:
