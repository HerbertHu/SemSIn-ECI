...
def get_parser():
    ...
    # model dir
    parser.add_argument('--save_model', type=str, default='esc_star_00')
    ...
    parser.add_argument('--sample_dir', type=str, default='data/EventStoryLine_star/sent_sample/')

    # amr dictionary path
    parser.add_argument('--vertex_dict', type=str,
                        default='data/EventStoryLine_star/amr_sample/amr_dict/vertex_dict.txt')
    parser.add_argument('--edge_dict', type=str,
                        default='data/EventStoryLine_star/amr_sample/amr_dict/edge_dict.txt')
    parser.add_argument('--graph_dir', type=str,
                        default='data/EventStoryLine_star/amr_sample/amr_graph/')
    parser.add_argument('--align_dir', type=str,
                        default='data/EventStoryLine_star/amr_sample/amr_align/')
    parser.add_argument('--path_dir', type=str,
                        default='data/EventStoryLine_star/amr_sample/amr_path/')
